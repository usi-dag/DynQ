...
const AFTERBURNER_STORE_SIZE = process.env.AFTERBURNER_STORE_SIZE || 'large';
...
function store_respond(size){
  ...
  if(size == 'verylarge') {
    confmemmax=(16*1024*1024*1024)-(64*1024*1024);
    conftmpstrStorageMB=1024;
    confbufPoolMB=512;
  }
}
...
//////////////////////////////////////////////////////////////////////////////
if(inNode){
  if(mem === undefined) init_store(AFTERBURNER_STORE_SIZE);
  module.exports.init_store = init_store;
...
//  module.exports.memF32= memF32;
  ...
  global.alarmingKeysp=alarmingKeysp;
  global.hdbsize32=hdbsize32;
} else delete module;
//////////////////////////////////////////////////////////////////////////////
