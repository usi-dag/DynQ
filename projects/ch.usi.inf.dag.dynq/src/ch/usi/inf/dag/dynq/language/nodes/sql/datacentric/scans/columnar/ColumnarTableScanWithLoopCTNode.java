...
public final class ColumnarTableScanWithLoopCTNode extends TruffleLinqExecutableNode {

  private final long nElements;
  private final ColumnarScanLoopWithCallTargetNode scanLoop;

  @Child
  private LoopNode loopNode;

  public ColumnarTableScanWithLoopCTNode(long nElements,
                                         DataCentricConsumerNode consumerNode) {
    this.nElements = nElements;
    this.scanLoop = new ColumnarScanLoopWithCallTargetNode(nElements, consumerNode);
