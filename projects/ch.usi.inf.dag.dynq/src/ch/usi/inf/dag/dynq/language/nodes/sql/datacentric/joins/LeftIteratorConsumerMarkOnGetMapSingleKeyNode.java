...
public final class LeftIteratorConsumerMarkOnGetMapSingleKeyNode extends LeftIteratorConsumerMarkOnGetMapNode {

    @Child
    private RexTruffleNode buildKeyGetter;

    public LeftIteratorConsumerMarkOnGetMapSingleKeyNode(RexTruffleNode buildKeyGetter) {
