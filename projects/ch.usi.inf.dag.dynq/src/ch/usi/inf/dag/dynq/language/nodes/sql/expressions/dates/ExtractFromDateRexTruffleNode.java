...
public abstract class ExtractFromDateRexTruffleNode extends IntegerRexTruffleNode {
    ...
    public static abstract class YearExtractorNode extends Node {
        ...
        @Specialization
        public int executeInternalDateWrapper(InternalDateWrapper date) {
            return LocalDate.ofEpochDay(date.getDaysOfEpoch()).getYear();
        }
    }
    ...
    public static abstract class MonthExtractorNode extends Node {
        ...
        @Specialization
        public int executeInternalDateWrapper(InternalDateWrapper date) {
            return LocalDate.ofEpochDay(date.getDaysOfEpoch()).getMonthValue();
        }
    }
