...
public final class ConstantStringEqNode extends BooleanRexTruffleNode {
    ...
    public ConstantStringEqNode(String constant, RexTruffleNode inputGetter) {
    ...
    public boolean runBoolean(VirtualFrame frame, Object input) throws InteropException, FrameSlotTypeException {
        ...
        for (int i = 0; i < chars.length; i++) {
            if(chars[i] != TruffleBoundaryUtils.getCharAt(inputString, i)) return false;
        }
        return true;
    }
