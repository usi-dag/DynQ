...
public abstract class AddRexTruffleNode extends BinaryRexForContainerTruffleNode {

    public static AddRexTruffleNode create() {
        return AddRexTruffleNodeGen.create();
    }
