...
public final class LeftIteratorConsumerMarkOnGetMapMultiKeysNode extends LeftIteratorConsumerMarkOnGetMapNode {

    @Child private ArrayRexTruffleNode buildKeyGetter;
    @Child private ArrayBoxHashNode boxHashNode;

    public LeftIteratorConsumerMarkOnGetMapMultiKeysNode(ArrayRexTruffleNode buildKeyGetter) {
