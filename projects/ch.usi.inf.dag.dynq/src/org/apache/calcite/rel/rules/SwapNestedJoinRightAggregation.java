...
public class SwapNestedJoinRightAggregation extends RelRule<SwapNestedJoinRightAggregation.Config> implements SubstitutionRule {
    ...
    public interface Config extends RelRule.Config {
        SwapNestedJoinRightAggregation.Config DEFAULT = ImmutableSwapNestedJoinRightAggregation.Config.of()
        ...
        default SwapNestedJoinRightAggregation.Config withOperandFor(Class<? extends Join> joinClass,
                                                                     Class<? extends Aggregate> aggregateClass) {

            return (SwapNestedJoinRightAggregation.Config)
