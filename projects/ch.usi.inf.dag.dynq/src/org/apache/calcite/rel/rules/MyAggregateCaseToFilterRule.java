...
public class MyAggregateCaseToFilterRule extends RelOptRule implements SubstitutionRule {
    public static final MyAggregateCaseToFilterRule INSTANCE = new MyAggregateCaseToFilterRule();

    protected MyAggregateCaseToFilterRule() {
        super(operand(Aggregate.class, operand(Project.class, any())),
                RelFactories.LOGICAL_BUILDER, "MyAggregateCaseToFilterRule");
    ...
    private static @Nullable AggregateCall transform(AggregateCall aggregateCall,
        ...
        // Note: expand case A2 to deal with the case that cnt is type double
