package ch.usi.inf.dag.dynq_js.parser.tpch_hardcoded_plans;

import ch.usi.inf.dag.dynq.parser.SqlToCalciteRel;
...
public class PlanQ20 {
    ...
    static RelNode plan(APISessionManagement session) {
        ...
        FrameworkConfig config = Frameworks.newConfigBuilder()
                .parserConfig(SqlParser.Config.DEFAULT.withLex(Lex.JAVA))
    ...
    group by l_partkey, l_suppkey
        ...
        * */
        ...
        RelNode filter_lineitem = relBuilder
                ...
                .build();
        filter_lineitem = SqlToCalciteRel.expandSearch(filter_lineitem);
        RelNode group_lineitem = relBuilder
                ...
                .aggregate(
                        ...
                        relBuilder.sum(getFieldInputRef(filter_lineitem, "l_quantity")).as("sumq"))
                .build();
    ...
    and ps_availqty > 0.5 * sumq
        ...
        * */
                        ...
                        relBuilder.call(
                                ...
                                relBuilder.call(
                                        ...
                                        relBuilder.call(
                                                ...
                                                relBuilder.literal(new BigDecimal("0.5")),
                                                getFieldInputRefJoinRightSide(group_lineitem, "sumq", ps_part))
                                )))
                .build();
        ...
        sorted = SqlToCalciteRel.expandSearch(sorted);
        ...
        return SqlToCalciteRel.expandSearch(converted);
    }
...
//                .replace(root.getConvention())
    ...
    static RexInputRef getFieldInputRefJoinRightSide(RelNode relNode, String fieldName, RelNode left) {
        RelDataTypeField field = getField(relNode, fieldName);
        return rexBuilder.makeInputRef(field.getType(), left.getRowType().getFieldCount() + field.getIndex());
    }
}
