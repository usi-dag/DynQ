...
import ch.usi.inf.dag.dynq.runtime.utils.DynQDateUtils;
...
public abstract class ExtractFromDateRexTruffleNode extends IntegerRexTruffleNode {
    ...
    public static abstract class YearExtractorNode extends Node {
        ...
        @Specialization
        public int executeRDateWrapper(Double date) {
            return DynQDateUtils.yearFromDays(date.intValue());
        }
    }
    ...
    public static abstract class MonthExtractorNode extends Node {
        ...
        @Specialization
        public int executeRDateWrapper(Double date) {
            return DynQDateUtils.monthFromDays(date.intValue());
        }
    }
